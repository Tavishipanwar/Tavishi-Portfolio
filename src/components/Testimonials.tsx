    ...
    <section className="py-16 sm:py-32 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10" ref={ref}>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
          {awards.map((award, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-card rounded-2xl p-5 sm:p-8 border border-border card-hover h-full relative overflow-hidden">
                {/* Trophy Icon */}
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl gradient-bg flex items-center justify-center text-white mb-4 sm:mb-6">
        ...
        <motion.div
          ...
          className="mt-10 sm:mt-16 bg-card rounded-2xl p-5 sm:p-8 border border-border"
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 text-center">
            <div>
              <div className="text-2xl sm:text-4xl font-bold gradient-text">250+</div>
              <div className="text-muted-foreground mt-2">Manual Hours Eliminated Annually</div>
            </div>
            <div>
              <div className="text-2xl sm:text-4xl font-bold gradient-text">20%</div>
              <div className="text-muted-foreground mt-2">Workflow Efficiency Improvement</div>
            </div>
            <div>
              <div className="text-2xl sm:text-4xl font-bold gradient-text">40%</div>
