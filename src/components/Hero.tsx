...
const roles = ["Product Manager", "Technical Product Professional", "Data-Driven Strategist", "AI Enthusiast"];
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-1/4 -right-32 w-96 h-96 bg-pink-500/20 rounded-full blur-3xl blob"
          animate={{ x: [0, -50, 0], y: [0, -30, 0] }}
